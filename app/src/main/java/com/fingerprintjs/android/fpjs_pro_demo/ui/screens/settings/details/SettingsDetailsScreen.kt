...
private fun Preview() {
    AppTheme {
        SettingsDetailsScreenInternal(
            state = StateMocks.settingsDetailsUiState,
        )
    }
}
...
private fun PreviewDisabled() {
    AppTheme {
        SettingsDetailsScreenInternal(
            state = StateMocks.settingsDetailsUiStateDisabled,
        )
    }
}
...
private fun PreviewWithDialog() {
    AppTheme {
        SettingsDetailsScreenInternal(state = StateMocks.settingsDetailsUiStateWithPrompt)
    }
}
